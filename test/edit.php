...
<?php
    if(isset($_POST["btn-submit"])){
        ...
        if(empty($name) || empty($price) || empty($category) || empty($status)){
            ...
            $id = $_GET["editId"];
            $sql = "UPDATE rasika_list_products 
            SET name = '$name',
            price = '$price',
            category = '$category',
            status = '$status' 
...
<html lang="en">
  ...
  <?php
    $id = $_GET['id'];
    $sql = "SELECT * FROM rasika_list_products WHERE id = '$id'";
...
<div class="form-group">
  ...
  <div class="form-group">
    ...
    <input type="text" class="form-control" id="status" name="status" placeholder="Enter product status" value="<?php echo($status);?>">
  </div>
  <input class="btn btn-success btn-block" type="submit" id="btn-submit" name="btn-submit" value="Edit Product">
</form>
